...
| Modules | feature-first (see [Module Dependency Rules](architecture.md#module-dependency-rules) in architecture.md for multi-module arrows) | giant "domain/data/presentation" package islands |
...
For the full annotated `CreateItemViewModel` with async work (standalone and base-class variants), see [mvi.md](mvi.md#code-examples).
